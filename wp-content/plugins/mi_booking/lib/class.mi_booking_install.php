    ...
    class MI_Install {
        ...
        static function install() {
            ...
            $booking_time_tamplate_data = array(
                array(1, 'WD', '17:00', '1500'),
				array(2, 'WD', '18:15', '1500'),
				array(3, 'WD', '19:30', '1500'),
				array(4, 'WD', '20:45', '1500'),
				array(5, 'WD', '22:00', '1500'),
				array(6, 'F', '17:00', '2000'),
				array(7, 'F', '18:15', '2000'),
				array(8, 'F', '19:30', '2000'),
				array(9, 'F', '20:45', '2000'),
				array(10, 'F', '22:00', '2000'),
				array(11, 'WE', '12:00', '2000'),
				array(12, 'WE', '13:15', '2000'),
				array(13, 'WE', '14:30', '2000'),
				array(14, 'WE', '15:45', '2000'),
				array(15, 'WE', '17:00', '2000'),
				array(16, 'WE', '18:15', '2000'),
				array(17, 'WE', '19:30', '2000'),
				array(18, 'WE', '20:45', '2000'),
				array(19, 'WE', '22:00', '2000'),               
            );
            foreach ($booking_time_tamplate_data as $data)
            {
				list($id,$what_day,$time,$cost) = $data;
				$check = $wpdb->query("SELECT * FROM " . self::$booking_time_tamplate_base . "__1 WHERE id = $id ");
				if( !$check ){
					$wpdb->insert(
			...
			$check = $wpdb->query("SELECT * FROM " . self::$table_of_rooms . " WHERE id = 1 ");
			if( !$check ){
				$wpdb->insert(
						self::$table_of_rooms,
						array( 
            ...
            $option_added = add_option('mi_booking');
			if( $option_added ){
