(function($){  
    $.iphoneStyle = {
        defaults: { checkedLabel: '<i class="fa fa-power-off"></i>', uncheckedLabel: '<i class="fa fa-power-off"></i>', background: '#fff' }
    }
    ...
    return this.each(function() {
      ...
      elem.after('<div class="handle"><div class="bg" style="background: ' + options.background + '"/><div class="slider" /></div>')
          .after('<label class="off" for="'+id+'">'+ options.uncheckedLabel + '</label>')
          .after('<label class="on" for="'+id+'">' + options.checkedLabel   + '</label>');
